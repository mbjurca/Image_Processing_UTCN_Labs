...
int main() {
    Mat source = imread("YOUR_PATH_HERE/images/Hawkes_Bay_NZ.bmp",
                        IMREAD_GRAYSCALE);
    ...
    Mat img_bin_th = imread("YOUR_PATH_HERE/images/eight.bmp",
                            IMREAD_GRAYSCALE);
    ...
    Mat img_histogram_stretching = imread("YOUR_PATH_HERE/images/Hawkes_Bay_NZ.bmp",
                                          IMREAD_GRAYSCALE);
    ...
    Mat img_histogram_shrink = imread("YOUR_PATH_HERE/images/wheel.bmp",
                                      IMREAD_GRAYSCALE);
    ...
    Mat img_gamma_correction = imread("YOUR_PATH_HERE/images/wilderness.bmp",
                                      IMREAD_GRAYSCALE);
    ...
    Mat histogram_eq_1_image = imread("YOUR_PATH_HERE/images/Hawkes_Bay_NZ.bmp", IMREAD_GRAYSCALE);
    Mat histogram_eq_2_image = imread("YOUR_PATH_HERE/images/wheel.bmp", IMREAD_GRAYSCALE);
